<%-- 
    Document   : ProdottiPerCategoria
    Created on : 22-ott-2014, 9.19.15
...
<html>
    ...
    <body>
        ...
        <h2>Videogiochi <%=categoria%></h2>
        <%
            LinkedList<VideogiocoPrint> elencoP = (LinkedList<VideogiocoPrint>) request.getAttribute("prodotti_" + categoria + "#rp" + request.getParameter("rp"));//rp = result page
        ...
        <div id="elenco" align="center" style="align:center;">
            ...
            <table>
                ...
                <a href="index.jsp?pagina=showCat&cat=<%=request.getParameter("cat")%>&rp=<%=i%>"><%=i%></td> 
                    </td>
                    <%
                            }
                        }
